...
(function () {
  ...
  if (window.addEventListener) {
    var e = (window.StyleFix = {
      link: function (a) {
        ...
        g = function () {
          ...
          if (
            b &&
            a.parentNode &&
            (!d.status || 400 > d.status || 600 < d.status)
          ) {
            b = e.fix(b, !0, a);
            f &&
              ((b = b.replace(
        ...
        try {
          ...
          "undefined" != typeof XDomainRequest &&
            ...
            (d.onerror = d.onprogress = function () {}),
            (d.onload = g),
            d.open("GET", c),
            d.send(null));
        }
      ...
      process: function () {
        h('link[rel="stylesheet"]:not([data-inprogress])').forEach(
          StyleFix.link
        );
  ...
  if (window.StyleFix && window.getComputedStyle) {
    var a = (window.PrefixFree = {
      prefixCSS: function (b, c) {
        ...
        if (a.properties.length)
          var i = RegExp("\\b(" + a.properties.join("|") + ")(?!:)", "gi"),
            b = e(
              "valueProperties",
              "\\b",
              ":(.+?);",
    ...
    (function () {
        ...
        d = function (a) {
          if ("-" === a.charAt(0)) {
            ...
            for (b[d] = ++b[d] || 1; 3 < a.length; )
              a.pop(),
                (d = a.join("-")),
                StyleFix.camelCase(d) in i && -1 === c.indexOf(d) && c.push(d);
          }
        };
      ...
      for (g = 0; g < c.length; g++)
        (e = c[g]),
          0 === e.indexOf(a.prefix) &&
            ((j = e.slice(a.prefix.length)),
            StyleFix.camelCase(j) in i || a.properties.push(j));
      "Ms" == a.Prefix &&
        !("transform" in i) &&
        !("MsTransform" in i) &&
        "msTransform" in i &&
    ...
    (function () {
      ...
      for (var j in f)
        (h = f[j]), !b(j, h) && b(a.prefix + j, h) && a.keywords.push(j);
    })();
    (function () {
      function b(a) {
        e.textContent = a + "{}";
      ...
      for (var k in f)
        (g = k + " " + (f[k] || "")),
          !b("@" + g) && b("@" + a.prefix + g) && a.atrules.push(k);
      h.removeChild(e);
    })();
