    ...
    getZoomPlaceholder: function () {
      ...
      return i
        ? ((e = i.substring(0, i.lastIndexOf("/"))),
          e.substring(0, e.lastIndexOf("/") + 1) + "img/loading.gif" + a)
        : a;
    },
    isBs: function (t) {
    ...
    (i.prototype = {
          ...
          (i = a.resumableManager =
            {
                ...
                (i.completed = !0),
                  ...
                  "success" === t
                    ? ((o.uploadedSize += i.file.size),
                      ...
                      a._raise("fileuploaded", [f.id, f.index, f.fileId]),
                    ...
                    : "cancel" !== t &&
                      ...
                      a.$errorContainer.find(
                        ...
                        e.extend(f, s),
                        a._showFileError(n, f, "filemaxretries"),
                        p &&
                          (o.removeFile(l),
                          delete i.chunksProcessed[l],
                          o.isProcessed() && a._setProgress(101)))),
              ...
              processUpload: function () {
                ...
                return r.testUrl
                  ? ((n = new FormData()),
                    ...
                    (l = function (e) {
                      (f = a._getOutData(n, e)),
                        a._raise("filetestbeforesend", [p, o, i, f]);
                    }),
                    (d = function (r, s, l) {
                      ...
                      var d = a.uploadParamNames,
                        ...
                        u = [p, o, i, f];
                      r[c] && t.isArray(r[c])
                        ? (i.chunksProcessed[p] || (i.chunksProcessed[p] = {}),
                    ...
                    (c = function (e, t, r) {
                      (f = a._getOutData(n, e)),
                        a._raise("filetestajaxerror", [p, o, i, f]),
              ...
              sendAjax: function (e, s, l) {
                ...
                if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                  if (s > r.maxRetries)
                    return (
                      h(g.resumableMaxRetriesReached, { n: r.maxRetries }),
                  ...
                  (v = new FormData()),
                    ...
                    (b = function (r) {
                      (w = a._getOutData(v, r)),
                        a.showPreview &&
                          (p.hasClass("file-preview-success") ||
                            (a._setThumbStatus(p, "Loading"),
                            t.addCss(p, "file-uploading")),
                          m.attr("disabled", !0)),
                    ...
                    (_ = function (t, d, c) {
                      ...
                      var f = a.uploadParamNames,
                        p = f.chunkIndex || "chunkIndex",
                        m = [u, e, s, o, i, w];
                      t.error
                        ? (r.showErrorLog &&
                    ...
                    (C = function (t, r, n) {
                      return a._isAborted()
                        ? void h(g.resumableAborting)
                        : ((w = a._getOutData(v, t)),
                          i.setAjaxError(t, r, n),
                          a._raise("filechunkajaxerror", [u, e, s, o, i, w]),
                          i.pushAjax(e, s + 1),
                          void h(g.resumableRetryError, { n: s - 1 }));
                    }),
                    (x = function () {
                      a._isAborted() ||
      ...
      _initTemplateDefaults: function () {
        ...
        (i =
          ...
          (B = " {style}"),
          (S = q("html", "text/html")),
          (E = q("text", "text/plain;charset=UTF-8")),
        ...
        (i.previewCache = {
          ...
          get: function (e, a) {
            var r,
              ...
              p = f.config[e],
              g = f.content[e],
              m = t.ifSet("previewAsData", p, i.initialPreviewAsData),
              h = p
            ...
            return g && g.length
              ? ((a = void 0 === a ? !0 : a),
                (o = t.ifSet("type", p, i.initialPreviewFileType || "generic")),
                (l = t.ifSet("filename", p, t.ifSet("caption", p))),
                (d = t.ifSet("filetype", p, o)),
                (s = i.previewCache.footer(e, a, (p && p.size) || null)),
                (c = t.ifSet("frameClass", p)),
                (r = m
                  ? v(o, g, l, d, s, u, c)
                  : v("generic", g, l, d, s, u, c, o).setTokens({
                      content: f.content[e],
                    })),
                f.tags.length && f.tags[e] && (r = t.replaceTags(r, f.tags[e])),
                t.isEmpty(p) ||
                  t.isEmpty(p.frameAttr) ||
                  ((n = t.createElement(r)),
                  n.find(".file-preview-initial").attr(p.frameAttr),
                  (r = n.html()),
                  n.remove()),
                r)
              : "";
          ...
          footer: function (e, a, r) {
            ...
            var o,
              ...
              m = i.initialPreviewDownloadUrl
                ...
                : "",
              h = s.downloadUrl || m,
              v = s.filename || s.caption || "",
              w = !!h,
              b = t.ifSet("showRemove", s, g),
              _ = t.ifSet("showRotate", s, t.ifSet("showRotate", p, !0)),
              C = t.ifSet("showDownload", s, t.ifSet("showDownload", p, w)),
              x = t.ifSet("showZoom", s, t.ifSet("showZoom", p, !0)),
              y = t.ifSet("showDrag", s, t.ifSet("showDrag", p, !0)),
              T = c === !1 && a;
            return (
              (C = C && s.downloadUrl !== !1 && !!h),
              (o = i._renderFileActions(
                s,
                !1,
                C,
                b,
          ...
          (t && t.fileId
            ? (i ||
                r.$errorContainer
                  ...
                  .remove(),
              (a = r.fileManager.getFileName(t.fileId)),
              a && (e = "<b>" + a + ":</b> " + e))
            : i || r.$errorContainer.html(""),
          r._showFileError(e, t, "fileusererror"));
      },
      ...
      _raise: function (t, i) {
        ...
        if ("filebatchpreupload" === r.type && (n || o))
      ...
      _initZoomButtons: function () {
        var t,
          ...
          r = a.$modal,
          n = r.data("previewId") || "",
          o = a.getFrames().toArray(),
          s = o.length,
          l = r.find(".btn-kv-prev"),
          d = r.find(".btn-kv-next");
      ...
      _setZoomContent: function (i, a) {
        ...
        y &&
          ...
          (m = w
            .html()
            .replace(h.zoomPlaceholder, "")
            .setTokens({ zoomData: y })),
          w.html(m),
          i.data("zoom", ""),
          w.attr("data-zoom", y)),
          (n = w.attr("data-template") || "generic"),
          (r = w.find(".kv-file-content")),
          (o = r.length ? r.html() : ""),
          (p = i.data("caption") || h.msgZoomModalHeading),
          (g = i.data("size") || ""),
          (u = i.data("description") || ""),
          b.find(".kv-zoom-caption").attr("title", p).html(p),
          b.find(".kv-zoom-size").html(g),
          (f = b.find(".kv-zoom-description").hide()),
          u &&
            (h.showDescriptionClose &&
              (u =
                h
                  ._getLayoutTemplate("descriptionClose")
                  .setTokens({ closeIcon: h.previewZoomButtonIcons.close }) +
                "</button>" +
                u),
            f.show().html(u),
            h.showDescriptionClose &&
              h._handler(b.find(".kv-desc-hide"), "click", function () {
                e(this)
                  .parent()
          ...
          (s = b.find(".kv-zoom-body")),
          b.removeClass("kv-single-content"),
          a
            ? ((c = s.addClass("file-thumb-loading").clone().insertAfter(s)),
              t.setHtml(s, o).hide(),
            ...
            : t.setHtml(s, o),
          (d = h.previewZoomSettings[n]),
          d &&
            ((l = s.find(".kv-preview-data")),
          ...
          b.data("previewId", v),
          h._handler(b.find(".btn-kv-prev"), "click", function () {
          ...
          h._handler(x, "click", function () {
            var e,
              ...
              r = function (e) {
                var i = h.$modal.find(".kv-zoom-body"),
                  a = h.zoomModalHeight;
          ...
          h._handler(b, "keydown", function (t) {
            var i,
              ...
              r = t.which || t.keyCode,
              n = h.processDelay + 1,
              o = e(this).find(".btn-kv-prev"),
              s = e(this).find(".btn-kv-next"),
              l = e(this).data("previewId");
            ([i, a] = h.rtl ? [39, 37] : [37, 39]),
              e.each({ prev: [o, i], next: [s, a] }, function (e, t) {
                var i = t[0],
                  a = t[1];
                r === a &&
                  i.length &&
      ...
      _showModal: function (e) {
        ...
        e &&
          e.length &&
          (t.initModal(o),
          t.setHtml(o, n._getModalContent()),
          n._setZoomContent(e),
          o.removeClass("rotatable"),
          o.data({ backdrop: !1, fileinputPluginId: n.$element.attr("id") }),
          o.find(".kv-zoom-body").css("height", n.zoomModalHeight),
          (i = e.find(".kv-file-content > :first-child")),
          i.length &&
            ((a = i.css("transform")),
            a && o.find(".file-zoom-detail").css("transform", a)),
          e.hasClass("rotatable") && o.addClass("rotatable"),
          e.data("angle") && o.data("angle", e.data("angle")),
          (r = e.data("angle") || 0),
          o.modal("show"),
          n._initZoomButtons(),
      ...
      _zoomSlideShow: function (t, i) {
        var a,
          ...
          d = this,
          c = d.$modal,
          u = c.find(".kv-zoom-actions .btn-kv-" + t),
          f = d.getFrames().toArray(),
          p = [],
          g = f.length;
        if (
          (d.reversePreviewOrder && (t = "prev" === t ? "next" : "prev"),
          !u.attr("disabled"))
        ) {
          for (r = 0; g > r; r++)
            (n = e(f[r])),
          ...
          0 > o ||
            ...
            !p[o] ||
            ((a = e(p[o])),
            a.length && d._setZoomContent(a, t),
            d._initZoomButtons(),
            a.length && a.hasClass("rotatable")
              ? ((s = a.data("angle") || 0),
                c.addClass("rotatable").data("angle", s),
                (l = a.find(".kv-file-content > :first-child")),
                d._initRotateZoom(a, l))
              : c.removeClass("rotatable").removeData("angle"),
            d._raise("filezoom" + t, { previewId: i, modal: d.$modal }));
        }
      },
      ...
      _initUploadSuccess: function (i, a, r) {
        var n,
          ...
          p,
          g = this;
        return !g.showPreview || "object" != typeof i || e.isEmptyObject(i)
          ? void g._resetCaption()
          : (void 0 !== i.initialPreview &&
              ...
              d.length > 0 &&
                !t.isArray(d) &&
                (d = d.split(g.initialPreviewDelimiter)),
              d.length &&
                (g._mergeArray("initialPreview", d),
                g._mergeArray("initialPreviewConfig", c),
                g._mergeArray("initialPreviewThumbTags", u)),
              void 0 !== a
                ? r
                  ? ((f = a.attr("id")),
                    (p = g._getUploadCacheIndex(f)),
                    null !== p &&
                      (g.uploadCache[p] = {
                        id: f,
                        content: d[0],
                  ...
                  : ((s = g.previewCache.add(d[0], c[0], u[0], n)),
                    (o = g.previewCache.get(s, !1)),
                    ...
                    a.fadeOut("slow", function () {
                      ...
                      e &&
                        ...
                        g._initPreviewActions(),
                        g._clearFileInput(),
                        a.remove(),
                        l.remove(),
                        g._initSortable();
                    }))
                : (g.previewCache.set(d, c, u, n),
                  g._initPreview(),
                  g._initPreviewActions())),
            void g._resetCaption());
      },
      ...
      _uploadSingle: function (i, a, r, n) {
        var o,
          ...
          x = new FormData(),
          y = b._getThumbId(a),
          T = C > 0 || !e.isEmptyObject(b.uploadExtraData),
          P = b.ajaxOperations.uploadThumb,
          k = _.getFile(a),
          F = { id: y, index: i, fileId: a },
          S = b.fileManager.getFileName(a, !0),
          I = function () {
        ...
        b.enableResumableUpload ||
          ((b.uploadInitiated = !0),
          b.showPreview &&
            ((s = _.getThumb(a)),
            (f = s.find(".file-thumb-progress")),
            (d = s.find(".kv-file-upload")),
            (c = s.find(".kv-file-remove")),
            f.show()),
          0 === C ||
            !T ||
            (b.showPreview && d && d.hasClass("disabled")) ||
            b._abort(F) ||
            ((w = function () {
              u ? _.errors.push(a) : _.removeFile(a),
                _.setProcessed(a),
                _.isProcessed() && ((b.fileBatchCompleted = !0), l());
            }),
            (l = function () {
              var e;
              b.fileBatchCompleted &&
                setTimeout(function () {
                  var i = 0 === _.count(),
                    a = _.errors.length;
                  b._updateInitialPreview(),
                    b.unlock(i),
                    i && b._clearFileInput(),
                    (e = b.$preview.find(".file-preview-initial")),
                    b.uploadAsync &&
                      e.length &&
                      (t.addCss(e, t.SORT_CSS), b._initSortable()),
                    b._raise("filebatchuploadcomplete", [
                      _.stack,
                      b._getExtraData(),
                    ]),
                    (b.retryErrorUploads && 0 !== a) || _.clear(),
                    b._setProgress(101),
                    (b.ajaxAborted = !1),
                    (b.uploadInitiated = !1);
                }, b.processDelay);
            ...
            (p = function (n) {
              (o = b._getOutData(x, n)),
                ...
                r || (b.ajaxAborted = !1),
                b.showPreview &&
                  (s.hasClass("file-preview-success") ||
                    (b._setThumbStatus(s, "Loading"),
                    t.addCss(s, "file-uploading")),
                  d.attr("disabled", !0),
                  c.attr("disabled", !0)),
                r || b.lock(),
                -1 !== _.errors.indexOf(a) && delete _.errors[a],
                b._raise("filepreupload", [o, y, i, b._getThumbFileId(s)]),
                e.extend(!0, F, o),
                b._abort(F) &&
                  (n.abort(),
                  r ||
                    (b._setThumbStatus(s, "New"),
                    s.removeClass("file-uploading"),
                    d.removeAttr("disabled"),
            ...
            (m = function (n, l, c) {
              ...
              (o = b._getOutData(x, c, n)),
                e.extend(!0, F, o),
                setTimeout(function () {
                  t.isEmpty(n) || t.isEmpty(n.error)
                    ? (b.showPreview &&
                        (b._setThumbStatus(s, "Success"),
                        d.hide(),
                        b._initUploadSuccess(n, s, r),
                        b._setProgress(101, f)),
                      b._raise("fileuploaded", [o, p, i, b._getThumbFileId(s)]),
                      r ? (w(), I()) : b.fileManager.remove(s))
                    : ((u = !0),
                      (g = b._parseError(
                        P,
                        c,
                        b.msgUploadError,
                        b.fileManager.getFileName(a)
                      )),
                      b._showFileError(g, F),
                      b._setPreviewError(s, !0),
                      b.retryErrorUploads || d.hide(),
                      r && (w(), I()),
                      b._setProgress(
                        101,
                        b._getFrame(p).find(".file-thumb-progress"),
                        b.msgUploadError
                      ));
                }, b.processDelay);
            }),
            (h = function () {
              b.showPreview &&
                ...
                c.removeAttr("disabled"),
                s.removeClass("file-uploading")),
                r ? l() : (b.unlock(!1), b._clearFileInput()),
                b._initSuccessThumbs();
            }),
            (v = function (t, i, n) {
              (g = b._parseError(P, t, n, b.fileManager.getFileName(a))),
                (u = !0),
                setTimeout(function () {
                  var i;
                  r && (w(), E()),
                    b.fileManager.setProgress(a, 100),
                    b._setPreviewError(s, !0),
                    b.retryErrorUploads || d.hide(),
                    e.extend(!0, F, b._getOutData(x, t)),
                    b._setProgress(
                      101,
                      b.$progress,
                      b.msgAjaxProgressError.replace("{operation}", P)
                    ),
                    (i =
                      b.showPreview && s ? s.find(".file-thumb-progress") : ""),
                    b._setProgress(101, i, b.msgUploadError),
                    b._showFileError(g, F);
                }, b.processDelay);
            }),
            b._setFileData(x, k.file, S, a),
            b._setUploadData(x, { fileId: a }),
            b._ajaxSubmit(p, m, h, v, x, a, i)));
      },
      ...
      _checkBatchPreupload: function (t, i) {
        var a = this,
          r = a._raise("filebatchpreupload", [t]);
        return r
          ? !0
          : (a._abort(t),
            i && i.abort(),
            a._getThumbs().each(function () {
              ...
              t.hasClass("file-preview-loading") &&
                (a._setThumbStatus(t, "New"), t.removeClass("file-uploading")),
      ...
      _uploadBatch: function () {
        var i,
          ...
          c = d.total(),
          u = {},
          f = c > 0 || !e.isEmptyObject(l.uploadExtraData),
          p = new FormData(),
        ...
        if (0 !== c && f && !l._abort(u)) {
          ...
          e.each(l.fileManager.stack, function (e, i) {
            t.isEmpty(i.file) ||
              l._setFileData(p, i.file, i.nameFmt || "untitled_" + m, e),
              m++;
          }),
      ...
      _handleRotation: function (t, i, a) {
        var r,
          ...
          b = !!w.length;
        return (
          b && w.addClass("kv-overflow-hidden"),
          !i.length || t.hasClass("hide-rotate")
            ? void (b && w.removeClass("kv-overflow-hidden"))
            : ((s = i.css("transform")),
              s && i.css("transform", "none"),
              s && i.css("transform", s),
              (a = a || 0),
              (o = a % 360),
              (r = "rotate(" + a + "deg)"),
              ...
              (g = ""),
              (90 !== o && 270 !== o) ||
                ((d = h.naturalWidth || i.outerWidth() || 0),
                (l = h.naturalHeight || i.outerHeight() || 0),
                (m = d > l && 0 != d ? (l / d).toFixed(2) : 1),
                v.length &&
                  ((u = v.height()),
                  (f = v.width()),
                  (c = Math.min(d, f)),
                  u > m * c && (m = c > u && 0 != c ? (u / c).toFixed(2) : 1)),
                1 !== m && (g = " scale(" + m + ")")),
              i.addClass("rotate-animate").css("transform", r + g),
              void setTimeout(function () {
                i.removeClass("rotate-animate").css("transform", n + g),
                  b && w.removeClass("kv-overflow-hidden"),
                  t.data("angle", o);
              }, p.fadeDelay))
        );
      },
          ...
          r.length &&
            ...
            a.hasClass("rotatable") &&
              r.on("click", function () {
                (n = (a.data("angle") || 0) + 90),
                  a.data("angle", n),
                  i._handleRotation(a, a.find(".file-zoom-detail"), n),
                  i._handleRotation(e, t, n),
                  e.hasClass("hide-rotate") && e.data("angle", n);
              }));
      },
          ...
          a.find(n).each(function () {
            ...
            if (!t.isEmpty(f) && void 0 !== p) {
              ...
              (x = parseInt(x.replace(t.INIT_FLAG, ""))),
                ...
                (h = { id: u.attr("id"), key: p, extra: b }),
                (n = function (e) {
                  (i.ajaxAborted = !1),
                    i._raise("filepredelete", [p, e, b]),
                    i._abort()
                      ? e.abort()
                      : (u.removeClass(l),
                ...
                (o = function (e, r, n) {
                  ...
                  return t.isEmpty(e) || t.isEmpty(e.error)
                    ...
                    : ((h.jqXHR = n),
                      ...
                      i._showFileError(a, h, "filedeleteerror"),
                ...
                (c = function (e, t, a) {
                  ...
                  (h.jqXHR = e),
                    (h.response = {}),
                    i._showFileError(r, h, "filedeleteerror"),
                    _.removeClass("file-uploading"),
                    u.removeClass("disabled " + s).addClass(l),
                    d();
                }),
      ...
      _generatePreviewTemplate: function (
        ...
        var v,
          ...
          A = T,
          z = "type-default",
          D = f || y._renderFileFooter(i, T, d, "auto", l),
          j = -1 !== e.inArray(S, y.alwaysPreviewFileExtensions),
          $ = y.preferIconicPreview && !j,
          U = y.preferIconicZoomPreview && !j,
          M = $ ? "other" : i;
        return (
          (b =
            400 > I
              ? y.previewSettingsSmall[M] || y.defaults.previewSettingsSmall[M]
              : y.previewSettings[M] || y.defaults.previewSettings[M]),
          b &&
          ...
          (_ = function (a, l, d, c, f) {
            var h,
              v = d ? "zoom-" + o : o,
              w = y._getPreviewTemplate(a),
              b = (u || "") + " " + c;
            return (
              y.frameClass && (b = y.frameClass + " " + b),
              d && (b = b.replace(" " + t.SORT_CSS, "")),
              (w = y._parseFilePreviewIcon(w, r)),
              "object" !== i ||
                n ||
                e.each(y.defaults.fileTypeSettings, function (e, t) {
                  "object" !== e &&
                    "other" !== e &&
                    t(r, n) &&
                    (z = "type-" + e);
              ...
              t.isEmpty(m) ||
                (void 0 !== m.title && null !== m.title && (E = m.title),
                void 0 !== m.alt && null !== m.alt && (A = E = m.alt)),
              (h = {
                previewId: v,
                caption: T,
                title: E,
              ...
              d && ((h.zoomCache = ""), (h.zoomData = "{zoomData}")),
              w.setTokens(h)
            );
          }),
          ...
          y.fileActionSettings.showZoom &&
            ...
            (P = _(U ? "other" : i, a, !0, C, h))),
          (P =
            "\n" +
            y._getLayoutTemplate("zoomCache").replace("{zoomContent}", P)),
          "function" == typeof y.sanitizeZoomCache &&
            (P = y.sanitizeZoomCache(P)),
          (C = "kv-preview-thumb"),
          x &&
            ((w =
              $ || y.hideThumbnailContent || !!y.previewFileIconSettings[S]),
            (C += " rotatable" + (w ? " hide-rotate" : ""))),
          (v = _($ ? "other" : i, a, !1, C, h)),
          v.setTokens({ zoomCache: P })
        );
      },
      ...
      _previewDefault: function (e, i) {
        ...
        if (a.showPreview) {
          var n,
            ...
            f = a.fileManager.getId(e),
            p = a._getThumbId(f);
          a._clearDefaultPreview(),
            (n = a._generatePreviewTemplate("other", u, o, s, p, f, c, l)),
            a._addToPreview(r, n),
            a._setThumbAttr(p, d, l),
            i === !0 &&
              a.isAjaxUpload &&
              a._setThumbStatus(a._getFrame(p), "Error");
        }
      },
      _previewFile: function (e, i, a, r, n) {
        if (this.showPreview) {
          var o,
            ...
            h = m.getId(i),
            v = s._getThumbId(h);
          (o = s._generatePreviewTemplate(u, g, l, d, v, h, !1, p, n.filename)),
            s._clearDefaultPreview(),
            s._addToPreview(f, o);
          var w = s._getFrame(v);
          s._validateImageOrientation(w.find("img"), i, v, h, c, d, p, g),
            s._setThumbAttr(v, c, p),
            s._initSortable();
        }
      },
      _setThumbAttr: function (e, t, i, a) {
        var r = this,
          n = r._getFrame(e);
        n.length &&
          ((i = i && i > 0 ? r._getSize(i) : ""),
          n.data({ caption: t, size: i, description: a || "" }));
      },
      _setInitThumbAttr: function () {
        var e,
          ...
          n,
          o = this,
          s = o.previewCache.data,
          l = o.previewCache.count(!0);
        if (0 !== l)
          for (var d = 0; l > d; d++)
            (e = s.config[d]),
              (n = o.previewInitId + "-" + t.INIT_FLAG + d),
              (i = t.ifSet("caption", e, t.ifSet("filename", e))),
              (a = t.ifSet("size", e)),
              (r = t.ifSet("description", e)),
              o._setThumbAttr(n, i, a, r);
      },
      ...
      _updateFileDetails: function (e) {
        var i,
          ...
          l = s.$element,
          d =
            (t.isIE(9) && t.findFileName(l.val())) ||
            (l[0].files[0] && l[0].files[0].name);
        !d && s.fileManager.count() > 0
          ? ((o = s.fileManager.getFirstFile()), (i = o.nameFmt))
          : (i = d ? s.slug(d) : "_"),
          (a = s.isAjaxUpload ? s.fileManager.count() : e),
          (n = s.previewCache.count(!0) + a),
          (r =
            1 === a ? i : s._getMsgSelected(n, !s.isAjaxUpload && !s.isError)),
          s.isError
            ? (s.$previewContainer.removeClass("file-thumb-loading"),
              s._initCapStatus(),
              s.$previewStatus.html(""),
              s.$captionContainer.removeClass("icon-visible"))
            : s._showFileIcon(),
          s._setCaption(r, s.isError),
          s.$container.removeClass("file-input-new file-input-ajax-new"),
          s._raise("fileselect", [e, i]),
          s.previewCache.count(!0) && s._initPreviewActions();
      },
        ...
        if (n.showPreview || (o && o.length)) {
          ...
          if (n.enableResumableUpload) {
            ...
            (m += h),
              ...
              (s = Math.floor((100 * g) / f)),
              (p.pendingBytes = f - g),
              n._setResumableProgress(s, p);
          } else
            l.setProgress(i, a),
              ...
              (p.pendingBytes = f - u),
              (s = t.round((u / f) * 100)),
              n._setProgress(s, null, null, n._getStats(p));
        }
      },
          ...
          : ((d = a[0]),
            ...
            ("Small" === e ? l >= f : f >= l)
              ...
              : ((s =
                ...
                c._showFileError(
                  s.setTokens({ name: n, size: f, dimension: l }),
                  o
                ),
                c._setPreviewError(r),
                c.fileManager.remove(r),
                c._clearFileInput(),
                !1));
      },
      _getExifObj: function (e) {
        ...
        return (
          !i &&
            a.showExifErrorLog &&
            a._log(t.logMessages.badExifParser, { details: r }),
          i
        );
      },
        ...
        return (
          ...
          f.canOrientImage
            ? (i.css("image-orientation", g ? "from-image" : "none"),
              void f._validateImage(r, n, o, s, l, d, p))
            : ((u = t.getZoomSelector(r, " img")),
              (c = p ? p["0th"][piexif.ImageIFD.Orientation] : null)
                ? (f.setImageOrientation(i, e(u), c, f._getFrame(r)),
                  f._raise("fileimageoriented", { $img: i, file: a }),
                  void f._validateImage(r, n, o, s, l, d, p))
                : void f._validateImage(r, n, o, s, l, d, p))
        );
      },
          ...
          g
            .one("load", function () {
              g.data("validated") ||
                ...
                (d = u.width()),
                l > d && g.css("width", "100%"),
                (s = { ind: p, id: e, fileId: t }),
                setTimeout(function () {
                  var l, d;
                  (l = c._isValidSize("Small", "Width", g, f, i, s)),
                    (d = c._isValidSize("Small", "Height", g, f, i, s)),
                    c.resizeImage ||
                      ((l = l && c._isValidSize("Large", "Width", g, f, i, s)),
                      (d = d && c._isValidSize("Large", "Height", g, f, i, s))),
        ...
        r === i.fileManager.totalImages &&
          ...
          i.resizeImage &&
            e.each(i.fileManager.loadedImages, function (e, o) {
              o.validated ||
                ((t = o.siz),
                t && t > n * i.bytesToKB && i._getResizedImage(e, o, a, r),
                (o.validated = !0));
            }));
      },
      _getResizedImage: function (i, a, r, n) {
        ...
        if (
          ((c = function (e, t, i) {
            h.isAjaxUpload ? h._showFileError(e, t, i) : h._showError(e, t, i),
              h._setPreviewError(I);
          }),
          (p = h.fileManager.getFile(i)),
          (g = { id: F, index: S, fileId: i }),
          (m = [i, F, S]),
          (!p || !y || (C >= w && x >= b)) &&
            (y && p && h._raise("fileimageresized", m),
            r.val++,
            r.val === n && h._raise("fileimagesresized"),
            !y))
        )
          return void c(h.msgImageResizeError, g, "fileimageresizeerror");
        (k = k || h.resizeDefaultImageType),
          (s = w > C),
          (l = b > x),
          (_ =
            "width" === h.resizePreference
              ? s
                ? C / w
                : l
                ? x / b
          ...
          (T.height = b);
        try {
          P.drawImage(v, 0, 0, w, b),
            (d = T.toDataURL(k, h.resizeQuality)),
            E &&
              ((f = window.piexif.dump(E)), (d = window.piexif.insert(f, d))),
            (o = t.dataURI2Blob(d)),
            h.fileManager.setFile(i, o),
            h._raise("fileimageresized", m),
            r.val++,
            r.val === n && h._raise("fileimagesresized", [void 0, void 0]),
            o instanceof Blob ||
              c(h.msgImageResizeError, g, "fileimageresizeerror");
        } catch (A) {
          r.val++,
            r.val === n && h._raise("fileimagesresized", [void 0, void 0]),
            (u = h.msgImageResizeException.replace("{errors}", A.message)),
      ...
      _renderFileFooter: function (e, i, a, r, n) {
        var o,
          ...
          p = d.showRotate,
          g = d.showZoom,
          m = l._getLayoutTemplate("footer"),
          h = l._getLayoutTemplate("indicator"),
          v = n ? d.indicatorError : d.indicatorNew,
          w = n ? d.indicatorErrorTitle : d.indicatorNewTitle,
          b = h.setTokens({ indicator: v, indicatorTitle: w });
        return (
          (a = l._getSize(a)),
          (s = {
            type: e,
      ...
      _renderFileActions: function (e, t, i, a, r, n, o, s, l, d, c, u, f) {
        ...
        var g,
          ...
          C = "",
          x = "",
          y = p._getLayoutTemplate("actions"),
          T = p.fileActionSettings,
        ...
        return (
          ...
          r &&
            (w = p
              ._getLayoutTemplate("actionRotate")
              .setTokens({
          ...
          i &&
            ...
            (x = x.setTokens({ filename: f, key: d }))),
          n &&
            (h = p
          ...
          o &&
            c &&
            ((g = "drag-handle-init " + T.dragClass),
            (v = p
      ...
      _change: function (i) {
        ...
        if (
          ...
          (n = a._getFileCount(o, h ? !1 : void 0)),
          g > 0 && n > g)
        ) {
      ...
      _canPreview: function (e) {
        ...
        var a,
          ...
          s = e.name || "",
          l = e.type || "",
          d = (e.size || 0) / i.bytesToKB,
          c = i._parseFileType(l, s),
          u = i.allowedPreviewTypes,
          f = i.allowedPreviewMimeTypes,
          p = i.allowedPreviewExtensions || [],
          ...
          w = new RegExp("\\.(" + p.join("|") + ")$", "i"),
          b = new RegExp("\\.(" + h.join("|") + ")$", "i");
        return (
          (a = !u || -1 !== u.indexOf(c)),
          (r = !f || -1 !== f.indexOf(l)),
          (n = !p.length || t.compare(s, w)),
          (o =
            (g && -1 !== g.indexOf(c)) ||
            (m && -1 !== m.indexOf(l)) ||
            (h.length && t.compare(s, b)) ||
            (v && !isNaN(v) && d > v)),
          !o && (a || r || n)
        );
      },
        ...
        r.fileManager.clearImages(),
          ...
          (a = function (w) {
            ...
            if (
              ...
              (M = function () {
                ...
                setTimeout(function () {
                  s.html(t),
                    ...
                    r.getFilesCount(!0) > 0 &&
                      r.getFrames(":visible") &&
                      r.$dropZone.find("." + r.dropZoneTitleClass).remove(),
                    a(w + 1);
                }, r.processDelay),
                  r._raise("fileloaded", [B, y, x, w, n]) && r.isAjaxUpload
                    ? e || C.add(B)
                    : e && C.removeFile(x);
              }),
              B)
              ...
              if (0 === A.length)
                return (
                  (k = r.msgInvalidFileName.replace(
                    "{name}",
                    t.htmlEncode(t.getFileName(B), "[unknown]")
                  )),
                  void v(k, B, y, w, D)
                );
              if (
                (t.isEmpty(m) ||
                  (H = new RegExp("\\.(" + m.join("|") + ")$", "i")),
                (r.isAjaxUpload && C.exists(D)) || r._getFrame(y, !0).length)
              ) {
                var G = { id: y, index: w, fileId: D, file: B, files: i };
                return (
                  (k = r.msgDuplicateFile.setTokens({ name: A, size: L })),
                  void (r.isAjaxUpload
                    ? (r.stackIsUpdating ||
                        (r.duplicateErrors.push(k),
                        (r.isDuplicateError = !0),
                        r._raise("fileduplicateerror", [B, D, A, L, y, w])),
                      a(w + 1),
                      r._updateFileDetails(u))
                    : (r._showError(k, G),
                      r.unlock(),
              ...
              if (r.maxFileSize > 0 && Z > r.maxFileSize)
                return (
              ...
              if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize))
                return (
              ...
              if (!t.isEmpty(p) && t.isArray(p)) {
                for (P = 0; P < p.length; P += 1)
                  (S = p[P]),
                    ($ = f[S]),
                    (W +=
                      $ && "function" == typeof $ && $(B.type, t.getFileName(B))
                        ? 1
                        : 0);
                if (0 === W)
                  return (
                    (k = r.msgInvalidFileType.setTokens({ name: A, types: V })),
                    void v(k, B, y, w, D)
                  );
              }
              if (
              ...
              if (!r._canPreview(B))
                return (
                  (j = r._raise("filebeforeload", [B, w, n])),
                  r.isAjaxUpload && j && C.add(B),
                  r.showPreview &&
                    j &&
                    ...
                    r._initFileActions()),
                  void setTimeout(function () {
                    j && r._updateFileDetails(u),
                      a(w + 1),
                      r._raise("fileloaded", [B, y, x, w]);
                  }, 10)
                );
              (U = N(B.type, A)),
                ...
                (n.onload = function (i) {
                  ...
                  if (
                    ...
                    (d = new Uint8Array(i.target.result)),
                      new FileTypeParser().parse(d).then(function (e) {
                        m((e && e.mime) || p, (e && e.ext) || "");
                      });
                  else {
                    if (0 === K) {
                      for (
                        d = new Uint8Array(i.target.result), P = 0;
                        P < d.length;
                        P++
                      )
                        (c = d[P].toString(16)), g.push(c);
      ...
      upload: function () {
        ...
        if (
          ...
          if (((r.lastProgress = 0), r._resetUpload(), 0 === o && !l))
          ...
          if ((r._setProgress(2), (r.hasInitData = !1), r.uploadAsync)) {
            ...
            return (
              ...
              void d
                ...
                .done(function () {
                  r._log("Async upload batch completed successfully."),
                ...
                .fail(function () {
                  r._log("Async upload batch completed with errors."),
